...
<AccordionGroup>
  ...
  <Accordion title="Available packages" icon="cube">
    ...
    - **`@cheapay/x402-hono`** - Hono framework middleware
    - **`@cheapay/x402-fetch`** - Fetch API client
    - **`@cheapay/x402-axios`** - Axios client integration
...
<CardGroup cols={2}>
  <Card title="Telegram Community" icon="telegram" href="https://t.me/cheapay_io_community">
