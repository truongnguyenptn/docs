...
<AccordionGroup>
  <Accordion icon="package" title="Choose your package manager">
  ...
  <Accordion icon="cube" title="Available packages">
    ...
    <Tip>Start with the core package and your framework-specific middleware.</Tip>
...
<AccordionGroup>
  <Accordion icon="code" title="Express.js setup">
  ...
  <Accordion icon="next" title="Next.js setup">
    ...
    <Tip>Your Next.js API routes are now payment-protected automatically!</Tip>
...
<Accordion icon="rocket" title="Start earning from API calls">
...
<Card
  title="GitHub Issues"
  icon="github"
  href="https://github.com/cheapay/x402-solana/issues"
>
